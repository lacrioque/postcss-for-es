...
import { default as plugin } from "./index";
...
describe("postcss-for", function () {
    it("it iterates from and to", function () {
        test("@for $i from 1 to 2 { .b-$i { width: $(i)px; } }", ".b-1 {\n    width: 1px\n}\n.b-2 {\n    width: 2px\n}");
    });
    it("it iterates from bigger to smaller", function () {
        test("@for $i from 3 to 1 { .b-$i { width: $(i)px; } }", ".b-3 {\n    width: 3px\n}\n.b-2 {\n    width: 2px\n}\n.b-1 {\n    width: 1px\n}");
    });
    it("it iterates from and to by two", function () {
        test("@for $i from 1 to 4 by 2 { .b-$i { width: $(i)px; } }", ".b-1 {\n    width: 1px\n}\n.b-3 {\n    width: 3px\n}");
    });
    it("it supports nested loops", function () {
        test("@for $i from 1 to 2 { @for $j from 1 to 2 {.b-$(i)-$(j) {} } }", ".b-1-1 {}\n.b-1-2 {}\n.b-2-1 {}\n.b-2-2 {}");
    });
    it("it supports ranges with a variable from the parent for loop", function () {
        test("@for $j from 1 to 3 { @for $i from 1 to $j {.b-$(i)-$(j) {} } }", ".b-1-1 {}\n.b-1-2 {}\n.b-2-2 {}\n.b-1-3 {}\n.b-2-3 {}\n.b-3-3 {}");
    });
    it("it supports ranges with variables from any parent for loop", function () {
        test("@for $w from 1 to 2 { @for $x from 1 to $w { @for $y from $x to $w { @for $z from $y to $w { .c-$(w)-$(z)-$(y)-$(x) {} }}}}", ".c-1-1-1-1 {}\n.c-2-1-1-1 {}\n.c-2-2-1-1 {}\n.c-2-2-2-1 {}\n.c-2-2-2-2 {}");
    });
    ...
    it("it supports ranges with negative numbers", function () {
        test("@for $i from -1 to 0 { .b-$i { width: $(i)px; } }", ".b--1 {\n    width: -1px\n}\n.b-0 {\n    width: 0px\n}");
    });
    it("it supports :root selector", function () {
        test(":root { \n@for $weight from 100 to 900 by 100 \n{ --foo-$(weight): $weight; }\n}\n.b { font-weight: var(--foo-200) }", ".b { font-weight: 200 }");
    });
